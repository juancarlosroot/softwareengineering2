...
public class TruthTable {
        ...
        for (int i = 0; i < clauses.size(); i++) {
            ...
            for (int j = 0; j < Px[i].sizeT(); j++) {
                for (int k = 0; k < Px[i].sizeF(); k++) {
                    ...
                    string_builder.append(
                            "(" + Px[i].getIndexOfTIn(j) + "," + Px[i].getIndexOfFIn(k) + ") "
                    );
                }
            }
            al_tmp.add(string_builder.toString());
            System.out.println();
        }
        return al_tmp;
    } //End GACC
    ...
    public ArrayList<String> GICC() {
        ...
        for (int i = 0; i < clauses.size(); i++) {
            ...
            System.out.print(printValuesOfGICC(a_true, a_false));
    ...
    /**
     * Imprime los valores del criterio Restricted Inactive Clause Coverage
     * (RICC)
     */
    public ArrayList<String> RICC() {
        ArrayList<Integer> aux_true, aux_false, a_true, a_false, b_true, b_false;
        ArrayList<String> al_tmp = new ArrayList<>();
        ...
        if (a_true.isEmpty() || a_false.isEmpty()) {
            ...
            while (iteratorA_true.hasNext()) {
                ...
                while (iteratorA_false.hasNext()) {
                    ...
                    return ("(" + elementA_true + "," + elementA_false + ") ");
                }
            }
        }
        return null;
    ...
    public ArrayList<String> print() {
        ArrayList<String> al_print = new ArrayList<>();

//        System.out.println("Truth table of " + p_infix + ":");
        StringBuilder string_builder = new StringBuilder();

//        System.out.print("row\t");
        string_builder.append("row");
        string_builder.append("\t");
        ...
        for (int i = 0; i < row; i++) {
            ...
            for (int j = 0; j < 2 * clauses.size() + 1; j++) {
                ...
                string_builder.append(table[i][j]);
                string_builder.append("\t");
            }
            System.out.println();
            al_print.add(
